...
class LinearClassifier(object):
    ...
    def predict(self, X):
        ...
        #    z[i] = np.matmul(self.W.transpose(),X[i,:])
...
class LinearSVM(LinearClassifier):
    ...
    def loss(self, X_batch, y_batch, reg):
        return svm_loss_naive(self.W, X_batch, y_batch, reg) #changed it to naive
...
class Softmax(LinearClassifier):
    ...
    def loss(self, X_batch, y_batch, reg):
        return softmax_loss_vectorized(self.W, X_batch, y_batch, reg) #changed it to naive
